...
namespace Characters.TamborineTurtle.Attacks
{
    ...
    public class AerialTailWhipAttack : IAttack {
        ...
        public void Enter(Metronome.Accuracy accuracy)
        {
            ...
            animator.SetTrigger("AerialTailWhip");
        ...
        public void HitPlayer(GameObject player) {
            ...
            Vector2 forceDirection = new Vector2(scale, scale * 3).normalized;
            hurtbox.TakePercentageKnockback(forceDirection, knockbackMulti, minimumKnockback, givenHitstun);
            // hurtbox.TakeFixedKnockBack(-fixedKnockbackForce, scale * fixedKnockbackForce / 3, givenHitstun);
        }
